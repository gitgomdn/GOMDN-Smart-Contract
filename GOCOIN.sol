...
contract GCOIN is SafeMath {
    ...
    address TAX_FEE_BIG_ADDRESS = 0x07e53650A8A5de01adA7D6a367534329ca607774;
...
*/
    ...
    function GCOIN(string _name, string _symbol, uint _supply, uint _price) public {
        totalSupply = _supply;
